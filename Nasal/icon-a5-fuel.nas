# Icon A5 fuel routines
# Copied from Velocity XL RG by Gary Neely aka 'Buckaroo'
##
...
# custom non-FDM engine management routines. See icon-a5_engine.nas for more information.
...
var MAX_TANKS		= 0;						# Standard tanks to consider, 0..MAX_TANKS
...
var fuel_pump		= props.globals.getNode("/systems/electrical/outputs/fuel-pump");
var HP_MAX		= getprop("/icon-a5/engine/power-max");
var PRESSURE_MAX	= getprop("/icon-a5/engine/fuel-pressure-max");
var PRESSURE_IDLE	= getprop("/icon-a5/engine/fuel-pressure-idle");
var PRESSURE_MIN	= getprop("/icon-a5/engine/fuel-pressure-min");
var PRESSURE_BOOST	= getprop("/icon-a5/engine/fuel-pressure-boost");
